...
function IPadCursorProvider({ children, config, }) {
    const { CursorType, resetCursor, disposeCursor, initCursor, updateCursor, updateConfig, customCursorStyle, } = useIPadCursorInit(config);
    return (React.createElement(CursorContext.Provider, { value: {
            CursorType,
            resetCursor,
            disposeCursor,
            initCursor,
